    ...
    public class LibUser
    {
       public static List<User> GetUsers()
        ...
        private static bool UserHasActiveOrders(LibraryContext context, User user)
        {
                try
                {
                    return context.Orders.Include(o => o.User).Any(o => o.User.UserId == user.UserId && o.State != null);
        ...
        private static bool HasRecentOrders(LibraryContext context, User user)
        {
            try
            {
                return context.Orders.Include(o => o.User).Any(o => o.User.UserId == user.UserId && o.ReturnDate.HasValue && (o.ReturnDate.Value - DateTime.Now).Days <365);
